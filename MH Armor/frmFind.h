...
namespace MHArmor {
	...
	public:
		...
		frmFind( RichTextBox^ text_box )
		{
			...
			txtFind->KeyDown += gcnew KeyEventHandler( this, &frmFind::KeyDown );
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnFind->Click += gcnew System::EventHandler(this, &frmFind::btnFind_Click);
			// 
			// btnClose
			// 
			...
			this->btnClose->Click += gcnew System::EventHandler(this, &frmFind::btnClose_Click);
			// 
			// frmFind
			// 
...
#pragma endregion
		...
		System::Void btnFind_Click(System::Object^  sender, System::EventArgs^  e)
		{
			...
			index = text_box->Text->IndexOf( txtFind->Text, start );
